...
description: >
  ...
  a 510(k) or De Novo strategy and wants to validate it with FDA first, or when
  they ask what questions to ask FDA about their device. This skill covers the
  full Pre-Submission drafting workflow including intake, pathway intelligence,
  question generation, document assembly, and FDA anticipation analysis.
---

# Q-Sub Meeting Request Drafter
...
The document structure follows real-world De Novo and 510(k) Q-Sub conventions
as filed with FDA CDRH, not generic templates.

---

## Step 0 — Identify User Persona

Ask this first. Output format and language calibration depends on it.

Ask: "Before we start, who are you in this process?"

- **A** — In-house RA professional at a medtech company
- **B** — Regulatory affairs consultant drafting for a client
- **C** — Startup founder or engineer without deep RA background
